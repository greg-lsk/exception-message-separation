...
/// </summary>
/// <typeparam name="TCaptured">The type of the exception that this interface applies to.</typeparam>
/// <remarks>
/// The <typeparamref name="TCaptured"/> type specified in this interface 
